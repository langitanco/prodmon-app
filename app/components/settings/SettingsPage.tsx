          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">
                Download semua data aplikasi dalam format JSON. Hanya dapat diakses oleh admin.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm p-4 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-bold text-slate-700 dark:text-slate-200">Export semua data</p>

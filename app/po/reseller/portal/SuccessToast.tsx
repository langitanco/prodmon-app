...
export function SuccessToast({ poNumber, waUrl, onClose }: SuccessToastProps) {
  ...
  return (
    <div className="fixed bottom-[24px] inset-x-0 px-4 z-[100] flex justify-center animate-slide-up pointer-events-none">
      <div className="bg-[#0e0e0e] w-full max-w-[420px] pointer-events-auto text-white rounded-[14px] shadow-[0_8px_32px_rgba(0,0,0,0.28)] overflow-hidden">
        ...
        <div className="p-[16px_18px]">
          <div className="flex items-start justify-between gap-3 mb-[12px]">
            ...
            <button
              onClick={onClose}
              className="text-white/30 hover:text-white/70 transition-colors mt-[1px] shrink-0"
            >
          ...
          <div className="bg-white/[0.07] border border-white/10 rounded-[8px] px-[14px] py-[9px] mb-[12px] flex items-center justify-between">
          ...
          <a
            ...
            className="w-full bg-[#25D366] text-white py-[9px] rounded-[8px] text-[13px] font-bold flex items-center justify-center gap-[7px] hover:opacity-90 transition-opacity decoration-transparent"
          >
